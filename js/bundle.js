...
function forms(formSelectror, modalTimerId) {
  // Forms

  const forms = document.querySelectorAll(formSelectror);
  const message = {
...
window.addEventListener("DOMContentLoaded", () => { 
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__.default)('.timer', '2020-11-04');
